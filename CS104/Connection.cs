...
namespace lib60870.CS104
{
    ...
    public delegate void InnerMessageHandler(string strMsg);
    ...
    public class Connection : Master
    {
        ...
        private void DebugLog(string message)
        {
            ...
            if (debugOutput)
            {
                ...
                {
                    innerMessageHandler("CS104 MASTER CONNECTION " + connectionID + ": " + message);
                }
            }
        }
        ...
        public void SetInnerMessageHandler(InnerMessageHandler inrMessageHandler)
        {
